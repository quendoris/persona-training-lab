...
from persona_training_lab.ui.agents.version_graph_persistent import VersionGraphCanvas
...
class AgentsScreen(QWidget):
    ...
    def _graph_panel(self) -> QWidget:
        ...
        self._graph = VersionGraphCanvas(build_version_lineage(self._vm.version_nodes()))
